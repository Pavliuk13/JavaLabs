...
public class First {
    public static void main(String[] args) {
        try {
            Map<Integer, Boolean> queue_status = new HashMap<Integer, Boolean>();

            QueuePerson person1 = new QueuePerson("Pavliuk", "Vasiliy", "Olex", new AddressValue("Kyiv", "Privokzalna", 19, 0, 1));
            ...
            LinkedList<QueuePerson> queue = new LinkedList<QueuePerson>();

            queue.add(person1); queue_status.put(person1.address.get_priority(), true);
            queue.add(person2); queue_status.put(person2.address.get_priority(), true);
...
class QueuePerson{
    ...
    public QueuePerson(String surname, String name, String patronymic, AddressValue address) throws BadAttributeValueExpException {
        if(surname == "" || name == "" || patronymic == ""){
            throw new BadAttributeValueExpException("Folders can't be empty");
        }
    ...
    public QueuePerson() throws BadAttributeValueExpException{
        Scanner in = new Scanner(System.in);
...
class AddressValue{
    ...
    public AddressValue(String city, String street, int house, int flat, int priority) throws BadAttributeValueExpException{
        if(city == "" || street == "" || house <= 0 || flat < 0 || priority <= 0){
